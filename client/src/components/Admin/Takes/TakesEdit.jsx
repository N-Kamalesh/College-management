...
function TakesEdit({ onSubmit, takes, onBack }) {
  const [data, setData] = useState({
    staffid: String(takes.staffid),
    courseid: takes.courseid,
    rollno: String(takes.rollno),
    sem: String(takes.sem),
    year: String(takes.year),
  });
  ...
  return (
    ...
    >
      ...
      <input
        ...
        placeholder="Enter the student rollno"
        type="text"
        name="rollno"
        value={data.rollno}
        autoComplete="off"
